...
impl<'a> TryFrom<Cow<'a, str>> for DuperTemporal<'a> {
    type Error = DuperTemporalTryFromError<'a>;

    /// Create a valid Temporal value from the provided [`Cow<'_, str>`],
    /// returning an error if parsing fails.
    fn try_from(value: Cow<'a, str>) -> Result<Self, Self::Error> {
        enum DuperTemporalType {
            Instant,
            ZonedDateTime,
            PlainDate,
            PlainTime,
        ...
        let result = match parser::temporal::temporal_specified()
            .parse(value.as_ref())
            .into_result()
        {
            Ok(temporal) => match temporal {
                DuperTemporal::Instant(_) => Ok(DuperTemporalType::Instant),
                DuperTemporal::ZonedDateTime(_) => Ok(DuperTemporalType::ZonedDateTime),
                DuperTemporal::PlainDate(_) => Ok(DuperTemporalType::PlainDate),
                DuperTemporal::PlainTime(_) => Ok(DuperTemporalType::PlainTime),
                DuperTemporal::PlainDateTime(_) => Ok(DuperTemporalType::PlainDateTime),
                DuperTemporal::PlainYearMonth(_) => Ok(DuperTemporalType::PlainYearMonth),
                DuperTemporal::PlainMonthDay(_) => Ok(DuperTemporalType::PlainMonthDay),
                DuperTemporal::Duration(_) => Ok(DuperTemporalType::Duration),
                DuperTemporal::Unspecified(_) => Ok(DuperTemporalType::Unspecified),
            },
        ...
        match result {
            Ok(typ) => match typ {
                DuperTemporalType::Instant => Ok(DuperTemporal::Instant(DuperTemporalInner(value))),
                DuperTemporalType::ZonedDateTime => {
                    Ok(DuperTemporal::ZonedDateTime(DuperTemporalInner(value)))
                }
                DuperTemporalType::PlainDate => {
                    Ok(DuperTemporal::PlainDate(DuperTemporalInner(value)))
                }
                DuperTemporalType::PlainTime => {
                    Ok(DuperTemporal::PlainTime(DuperTemporalInner(value)))
                }
                DuperTemporalType::PlainDateTime => {
                    Ok(DuperTemporal::PlainDateTime(DuperTemporalInner(value)))
                }
                DuperTemporalType::PlainYearMonth => {
                    Ok(DuperTemporal::PlainYearMonth(DuperTemporalInner(value)))
                }
                DuperTemporalType::PlainMonthDay => {
                    Ok(DuperTemporal::PlainMonthDay(DuperTemporalInner(value)))
                }
                DuperTemporalType::Duration => {
                    Ok(DuperTemporal::Duration(DuperTemporalInner(value)))
                }
                DuperTemporalType::Unspecified => {
                    Ok(DuperTemporal::Unspecified(DuperTemporalInner(value)))
                }
            },
